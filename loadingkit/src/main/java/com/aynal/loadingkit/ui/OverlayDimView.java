...
public class OverlayDimView extends FrameLayout {
    ...
    public OverlayDimView(Context context) {
        super(context);
    ...
    public void bind(LoadingOptions opts) {
        // dim overlay
        int alpha = (int) (255 * clamp01(opts.dimAmount));
        int dimColor = (alpha << 24); // black with alpha
        ...
        // message (subtitle) for non-text loaders
    ...
    public void start() {
        // For TEXT loader, TextAnimator is started in bind(). Renderer start for others:
